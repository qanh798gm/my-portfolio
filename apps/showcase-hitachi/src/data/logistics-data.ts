...
export const schedules: Schedule[] = [
  ...
  },
  {
    ...
    departure: '2024-03-07 11:00',
    status: 'Completed',
    driver: 'Nguyen V.',
    vehicleId: 'VH-005',
    mapQuery: 'Ho+Chi+Minh+City,Vietnam',
  },
  {
    id: 'SCH-005',
    route: 'SIN -> KUL',
    ...
    departure: '2024-03-10 07:00',
    status: 'On-Time',
    driver: 'Ahmad R.',
    vehicleId: 'VH-001',
    mapQuery: 'Kuala+Lumpur,Malaysia',
  },
  {
    id: 'SCH-006',
    route: 'HCM -> HAN',
    ...
    destination: 'Hanoi',
    departure: '2024-03-11 13:00',
    status: 'In Transit',
    driver: 'Tran H.',
    vehicleId: 'VH-009',
    mapQuery: 'Hanoi,Vietnam',
  },
  {
    id: 'SCH-007',
    route: 'OSK -> NGY',
    origin: 'Osaka',
    destination: 'Nagoya',
    departure: '2024-03-12 10:00',
    status: 'On-Time',
    driver: 'Hiroshi K.',
    vehicleId: 'VH-004',
    mapQuery: 'Nagoya,Japan',
  },
  {
    id: 'SCH-008',
    route: 'KUL -> BKK',
...
export const cargoItems: CargoItem[] = [
  ...
  {
    id: 'CGO-009',
    description: 'Semiconductor Wafers',
    weight: '650 kg',
    origin: 'Tokyo',
    destination: 'Singapore',
    scheduleId: 'SCH-009',
  ...
  {
    id: 'CGO-013',
    description: 'Optical Instruments',
    weight: '420 kg',
    origin: 'Tokyo',
    destination: 'Osaka',
    scheduleId: 'SCH-003',
