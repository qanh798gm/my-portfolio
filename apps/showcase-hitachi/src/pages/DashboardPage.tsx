    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
        <KpiCard
          ...
          value={kpiData.activeSchedules.value}
          delta={kpiData.activeSchedules.delta}
          trend={kpiData.activeSchedules.trend}
          icon="📋"
        />
        <KpiCard
          label="Total Vehicles"
          value={kpiData.totalVehicles.value}
          delta={kpiData.totalVehicles.delta}
          trend={kpiData.totalVehicles.trend}
          icon="🚛"
        />
        <KpiCard
          label="Cargo In Transit"
          value={kpiData.cargoInTransit.value}
          delta={kpiData.cargoInTransit.delta}
          trend={kpiData.cargoInTransit.trend}
          icon="📦"
        />
        <KpiCard
          label="On-Time Rate"
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
        ...
        >
          <h2 style={{ fontSize: 14, fontWeight: 600, color: '#e6edf3', margin: '0 0 4px' }}>
            Weekly Shipments
          </h2>
          <p style={{ fontSize: 12, color: '#484f58', margin: '0 0 16px' }}>
            Total dispatched vs delivered per week
          </p>
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={weeklyShipments} barSize={10}>
              ...
              <Tooltip
                ...
                labelStyle={{ color: '#8d96a0', fontSize: 11 }}
        ...
        >
          ...
          <p style={{ fontSize: 12, color: '#484f58', margin: '0 0 16px' }}>
            Delivery punctuality (%) over 8 weeks
          </p>
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={onTimeRates}>
              ...
              <Tooltip
                ...
                labelStyle={{ color: '#8d96a0', fontSize: 11 }}
                itemStyle={{ color: '#e6edf3', fontSize: 12 }}
                formatter={(v: unknown) => [`${String(v)}%`, 'On-Time Rate']}
              />
              <Line
                type="monotone"
                dataKey="rate"
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 16 }}>
        ...
        >
          ...
          <p style={{ fontSize: 12, color: '#484f58', margin: '0 0 8px' }}>
            Distribution of current shipments
          </p>
        ...
        >
          <h2 style={{ fontSize: 14, fontWeight: 600, color: '#e6edf3', margin: '0 0 16px' }}>
            Operations Summary
          </h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              >
                <div>
                  <p style={{ fontSize: 12, fontWeight: 500, color: '#8d96a0', margin: 0 }}>
                    {stat.label}
                  </p>
